...
#debug functions :
    ...
    def getPosPlayer(self,ply=None):
        if(ply):
            return self.player_positions[self.players[0]], self.player_positions[self.players[1]]
        else:
            return self.player_positions[self.players[self.ply]], self.ply
#-----------------
